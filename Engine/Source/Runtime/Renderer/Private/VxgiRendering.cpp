...
IMPLEMENT_VXGI_CONE_TRACING_SHADER_TYPE(TUniformLightMapPolicy<LMP_PRECOMPUTED_IRRADIANCE_VOLUME_INDIRECT_LIGHTING>, _LMP_PRECOMPUTED_IRRADIANCE_VOLUME_INDIRECT_LIGHTING);
	...
	TBasePassPixelShaderPolicyParamType<FUniformLightMapPolicyShaderParametersType>*& PixelShader)
{
	...
	case LMP_PRECOMPUTED_IRRADIANCE_VOLUME_INDIRECT_LIGHTING:
		GetConeTracingPixelShader<TUniformLightMapPolicy<LMP_PRECOMPUTED_IRRADIANCE_VOLUME_INDIRECT_LIGHTING>>(InVertexFactory, InMaterialResource, nullptr, PixelShader);
		break;
